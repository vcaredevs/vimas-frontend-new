      ...
      @change.prevent="onCategoryChange">
                                    ...
                                    <!-- <div class="widget-facet style-2">
                                        ...
                                        <div id="avaiable" class="collapse show">
                                            <ul class="collapse-body filter-group-check current-scrollbar">
                                                <li class="list-item">
                                                    <input type="radio" name="availability" class="tf-check style-4" id="inStock">
                                                ...
                                                <li class="list-item">
                                                    <input type="radio" name="availability" class="tf-check style-4" id="outStock">
                                    ...
                                    <div class="widget-facet style-2">
                                        ...
                                        <div id="skin" class="collapse show">
                                            <ul class="collapse-body filter-group-check current-scrollbar">
                                                ...
                                                <li class="list-item">
                                                    <input type="checkbox" name="skin" class="tf-check style-4" id="sentitive">
