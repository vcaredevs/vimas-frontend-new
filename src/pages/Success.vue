                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-12 left">
                        <div class="checkout-logo">
                            <div class="container">
                                <a href="http://192.168.1.120/shop.vcaretrichology/public" title="Vcare Shop">
                                    <img src="https://192.168.1.120/shop.vcaretrichology/public/storage/logo/vcare-logo.png#id=78" class="img-fluid" width="150" alt="Vcare Shop">
                                </a>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="container">
                            <h3 style="font-size: calc(1rem + .6vw);"> Customer information</h3>
                            <div class="order-customer-info">
                                ...
                                <div class="row" style="padding: 10px 0;">
                                    ...
                                    <div class="col-md-8">
                                        <span class="order-customer-info-meta"> {{ successRes.address?.name }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="padding: 10px 0;">
                                    ...
                                    <div class="col-md-8">
                                        <span class="order-customer-info-meta">{{ successRes.address?.phone }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="padding: 10px 0;">
                                    ...
                                    <div class="col-md-8">
                                        <span class="order-customer-info-meta">{{ successRes.address?.email }}</span>
                                    </div>
                                </div>
                                <div class="row" style="padding: 10px 0;">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <span class="order-customer-info-meta">{{ successRes.address?.address }} - {{ successRes.address?.zip_code }}
                                        </span>
                                    </div>
                                </div>
                                <div class="row" style="padding: 10px 0;">
                                    ...
                                    <div class="col-md-8">
                                        <span class="order-customer-info-meta text-end">Shipping Charge - ₹{{successRes.order?.shipping_amount}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="padding: 10px 0;">
                                    ...
                                    <div class="col-md-8">
                                        <span class="order-customer-info-meta" style="text-transform: uppercase"><span class="label-success status-label">Completed</span></span>
                                    </div>
                                </div>
                            </div>    
                        </div>  
                        ...
                        <div class="container">
                            <div class="pt-3 mb-4">
                                <div class="align-items-center">
                                    <h6 class="d-inline-block">Order number: {{successRes.order?.code}}</h6>
                                </div>

                                <div class="checkout-success-products">
                                    <div class="row show-cart-row d-md-none p-2">
                                        <div class="col-9">
                                            <a class="show-cart-link" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#cart-item-1381">
                                            ...
                                            <div class="row cart-item">
                                                <div class="col-lg-3 col-md-3">
                                                    <div class="checkout-product-img-wrapper">
                                                        <img class="item-thumb img-thumbnail img-rounded" :src="image_url+data.product?.image" :alt="data.product?.name">
                                                        <span class="checkout-quantity">{{ data.qty }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-4 float-end text-end">
                                                    <p>₹{{ (data.product.front_sale_price?? data.product.front_sale_price).toFixed(2) }}</p>
                                                </div>
                                            </div>                                            
                                        </template>                           
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 float-end">
                                    <p class="price-text text-end"> ₹{{successRes.order?.tax_amount}} </p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
