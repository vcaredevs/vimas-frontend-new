      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="container d-flex flex-column flex-lg-row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="hero-des text-center">
            ...
            <div class="col-lg-6 text-center fade-in mt-5 mt-lg-0">
                <img src="../assets/images/v6-banner.png" alt="Product Image" class="img-fluid">
            </div>
...
<!-- Features Section -->
<section class="bg-dark-gray text-white py-4">
    <div class="container d-flex flex-column flex-md-row justify-content-around text-center feature-icons">
        <div>
            <img src="../assets/images/icon_1.webp" alt="Vegan Icon">
            <p class="fw-light">VEGAN</p>
        </div>
        <div>
            <img src="../assets/images/Group.webp" alt="Chemicals Free Icon">
            <p class="fw-light">CHEMICALS FREE</p>
        </div>
        <div>
            <img src="../assets/images/icon_3.webp" alt="Not Tested Icon">
            <p class="fw-light">NOT TESTED ON ANIMALS</p>
        </div>
        <div>
            <img src="../assets/images/icon_4.webp" alt="Paraben Free Icon">
            <p class="fw-light">PARABEN FREE</p>
        </div>
        <div>
            <img src="../assets/images/icon_5.webp" alt="Organic Icon">
            <p class="fw-light">% 100 ORGANIC</p>
        </div>
    </div>
</section>
...
<section class="popular-sec">
  <div class="bg-img-one">
    <img src="../assets/images/sec-3-1-bg.png" alt="">
  </div>
  <div class="bg-img-two">
    <img src="../assets/images/sec-3-bg.png" alt="">
  </div>
    <div class="container">
        <div class="row">
...
<section class="about-sec">
  ...
  <div class="abt-para">
    Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. SedMaecenas nec
    odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Maecenas nec
...
<!---------grid section start------------>
<section class="hair-care-collect">
        ...
        <div class="col-lg-8 col-md-12 col-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="collect-item">
                <div class="img-wrapper">
                  <img src="../assets/images/grid1.webp" alt="Dandruff Care" class="zoom_image">
                </div>
                <div class="collect-text collect-text-right">
                  <h3>Dandruff care</h3>
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="collect-item">
                <div class="img-wrapper">
                  <img src="../assets/images/grid2.webp" alt="Hairfall" class="zoom_image">
                </div>
                <div class="collect-text collect-text-right">
                  <h3>Hairfall</h3>
                  <a href="#">View collection</a>
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="collect-item">
                <div class="img-wrapper">
                  <img src="../assets/images/grid3.webp" alt="Anti Lice Kit" class="zoom_image">
                </div>
                <div class="collect-text collect-text-left">
                  <h3>Anti lice kit</h3>
                  <a href="#">View collection</a>
                </div>
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="collect-item">
                <div class="img-wrapper">
                  <img src="../assets/images/grid4.webp" alt="Grey Hair" class="zoom_image">
                </div>
                <div class="collect-text collect-text-left">
                  <h3>Grey hair</h3>
                  <a href="#">View collection</a>
        ...
        <div class="col-lg-4 col-md-12 col-12">    
          <div class="row">
            ...
            <div class="col-12">
              <div class="collect-item">
                <div class="img-wrapper">
                  <img src="../assets/images/grid5.webp" alt="Grey Hair" class="patchy_hairloss_image zoom_image">
                </div>
                <div class="collect-text collect-text-left">
                  <h3>Patchy hairloss</h3>
                  <a href="#">View collection</a>
                </div>
              </div>
            </div>
...
<!----------V6 Journey section start--------->
<section class="journey-sevice">
  <div class="container">
    <div class="row justify-content-center">
      <div class="section_header">
      ...
      <div class="col-lg-11 col-md-12 ">
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="component-57-wrap jou-shine">
              <div class="component-57">
                <div class="component-57-inner">
                  <div class="component-57-inner">
              ...
              <div class="component-content">
                <img src="http://192.168.1.120/yourshands/storage/step-icon1.png" width="" height="" class="icon-test" alt="">
                <h3>
                  Take test
                </h3>
          
                <p class="para-step">
                  Begin your journey by taking a personalized hair test. This helps us understand your hair type, concerns, and
                  goals,
                  allowing us to recommend the best care solutions tailored specifically to you.
          
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 jou-shine">
            <div class="component-57-wrap">
              <div class="component-57">
                <div class="component-57-inner">
                  <div class="component-57-inner">
                    <div class="group-child">
              ...
              <div class="component-content">
                <img src="http://192.168.1.120/yourshands/storage/step-icon2.png" width="" height="" class="icon-test" alt="">
                <h3 class="plan">Buy Plan</h3>
                    <p class="para-step">Once we’ve analyzed your hair profile, choose a customized hair care plan that suits your needs. Our plans offer premium products and treatments designed to help you achieve healthy, beautiful hair.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 jou-shine">
              ...
              <div class="component-57">
                <div class="component-57-inner">
                  <div class="component-57-inner">
                    ...
                    <div class="step-1">STEP 3</div>
          
                  </div>
                </div>
              </div>
              <div class="component-content">
                <img src="http://192.168.1.120/yourshands/storage/step-icon3.png" width="" height="" class="icon-test" alt="">
                <h3 class="plan">Get Consultation</h3>
                    <p class="para-step">After purchasing your plan, receive expert advice from our professional hair specialists. They’ll guide you through the process, ensuring you get the best results with ongoing support and care to you.</p>
              </div>
            </div>
          </div>
...
<!----------V6 Journey section end--------->


<!----------2nd strip section start------------>
<section class="2nd-strip">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-11">
        <div class="strip-banner">
          <div class="stripbanner-overlay">
            <div class="stripbanner-text">
              <h3>Awesome Total Sale -50% Off For All Cosmetics<br>
              Kaline From Only $25</h3>
              <p>Discover ➡</p>
            </div>
    ...
    <div class="row justify-content-center">
       <div class="col-lg-10">
        <div class="row align-items-center">
          <div class="col-lg-6 ">
            <div class="bg-img-three">
              <img src="../assets/images/leaf-bg.png" alt="">
            </div>
            <div class="img-wrapper">
              <img class="zoom_image" src="../assets/images/image.webp" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="px-lg-4">
              <div class="image-des">
                <h3>Psoriacare Head and body shampoo</h3>
                <p>All are Herbal Cosmetics and it is formulated, using various permissible herbal cosmetic ingredients which are 100% safe & pure Herbal products.
                  <b>Starts from</b> <span>₹450</span></p>
                  <p>View Product ➡</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row image-ret align-items-center">
          <div class="col-lg-6">
            <div class="px-lg-4">
              <div class="image-des">
                <h3>Psoriacare Head and body shampoo</h3>
          ...
          <div class="col-lg-6">
            <div class="img-wrapper">
              <img class="zoom_image" src="../assets/images/image1.webp" />
            </div>
          </div>
        </div>
       </div>
      ...
      <div class="col-lg-11">
        <div class="swiper mySwiper">
          <div class="swiper-wrapper"><div class="swiper-slide">
                <img src="../assets/images/testmi.webp" width="" height="" class="one1" alt="">
                <div style="position: absolute;">
                  <div class="icon-main122">
                    <div class="Ellipse">
                      <h3 class="reviewer_name">Divya</h3>
                      <img src="../assets/images/client.webp" width="" height="" class="icon-test" alt="">
                    </div>
                    <div class="main-para">
                      <img src="../assets/images/review.png" width="" height="" alt="">
                      <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit,</span>
                    </div>
                  </div>
                </div>
...
<!----------our feed section start------------>
<section class="feed-sec">
  <div class="container">
    <div class="row">
      <div class="section_header">
        <h2 class="h2">Tag Us on Instagram</h2>
        <img src="../assets/images/heading-underline.png" class="heading_image" >
      </div>
    ...
    <div class="row">
      ...
      <div class="image-container">
        <img src="../assets/images/insta2.webp" alt="Image 1">
        <a href="https://www.instagram.com/" target="_blank">
          <div class="overlay">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 64 64"> <path d="M 31.820312 12 C 13.439312 12 12 13.439312 12 31.820312 L 12 32.179688 C 12 50.560688 13.439312 52 31.820312 52 L 32.179688 52 C 50.560688 52 52 50.560688 52 32.179688 L 52 32 C 52 13.452 50.548 12 32 12 L 31.820312 12 z M 28 16 L 36 16 C 47.129 16 48 16.871 48 28 L 48 36 C 48 47.129 47.129 48 36 48 L 28 48 C 16.871 48 16 47.129 16 36 L 16 28 C 16 16.871 16.871 16 28 16 z M 41.994141 20 C 40.889141 20.003 39.997 20.900859 40 22.005859 C 40.003 23.110859 40.900859 24.003 42.005859 24 C 43.110859 23.997 44.003 23.099141 44 21.994141 C 43.997 20.889141 43.099141 19.997 41.994141 20 z M 31.976562 22 C 26.454563 22.013 21.987 26.501437 22 32.023438 C 22.013 37.545437 26.501437 42.013 32.023438 42 C 37.545437 41.987 42.013 37.498562 42 31.976562 C 41.987 26.454563 37.498562 21.987 31.976562 22 z M 31.986328 26 C 35.299328 25.992 37.992 28.673328 38 31.986328 C 38.007 35.299328 35.326672 37.992 32.013672 38 C 28.700672 38.008 26.008 35.327672 26 32.013672 C 25.992 28.700672 28.673328 26.008 31.986328 26 z"></path> </svg>
          </div>
      ...
      <div class="image-container">
        <img src="../assets/images/insta3.webp" alt="Image 1">
        <a href="https://www.instagram.com/" target="_blank">
          <div class="overlay">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 64 64"> <path d="M 31.820312 12 C 13.439312 12 12 13.439312 12 31.820312 L 12 32.179688 C 12 50.560688 13.439312 52 31.820312 52 L 32.179688 52 C 50.560688 52 52 50.560688 52 32.179688 L 52 32 C 52 13.452 50.548 12 32 12 L 31.820312 12 z M 28 16 L 36 16 C 47.129 16 48 16.871 48 28 L 48 36 C 48 47.129 47.129 48 36 48 L 28 48 C 16.871 48 16 47.129 16 36 L 16 28 C 16 16.871 16.871 16 28 16 z M 41.994141 20 C 40.889141 20.003 39.997 20.900859 40 22.005859 C 40.003 23.110859 40.900859 24.003 42.005859 24 C 43.110859 23.997 44.003 23.099141 44 21.994141 C 43.997 20.889141 43.099141 19.997 41.994141 20 z M 31.976562 22 C 26.454563 22.013 21.987 26.501437 22 32.023438 C 22.013 37.545437 26.501437 42.013 32.023438 42 C 37.545437 41.987 42.013 37.498562 42 31.976562 C 41.987 26.454563 37.498562 21.987 31.976562 22 z M 31.986328 26 C 35.299328 25.992 37.992 28.673328 38 31.986328 C 38.007 35.299328 35.326672 37.992 32.013672 38 C 28.700672 38.008 26.008 35.327672 26 32.013672 C 25.992 28.700672 28.673328 26.008 31.986328 26 z"></path> </svg>
          </div>
  ...
  <div class="container">
    <div class="row align-items-center text-center">
      ...
      <div class="col-md-5">
        ...
        <form class="d-flex">
          <input type="email" class="form-control subscribe-input me" placeholder="Enter email id">
