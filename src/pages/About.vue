<template>
     ...
     <!-- Hero About -->
        <section class="section-cosmetic-hero-about flat-spacing-4">
            <div class="container-5">
                <div class="s-header-3 wow fadeZoom">
                    <h1 class="title fw-normal text-black text-center">
                        <span class="d-block mb-4">Our Guiding</span> Philosophy Ame.tic
                    </h1>
                </div>
                <div class="image radius-28 overflow-hidden">
        ...
        <!-- /Hero About -->
        <!--  -->
        <div class="section-cosmetic-info flat-spacing-4 pt-0">
            <div class="container-5">
                ...
                <p class="cl-gray-70 text-center">
                    Your skin holds both the responsibility & marvelous ability to protect you against external stressors.
                    <br class="d-none d-lg-block"> It bears touches, kisses, cold, heat & so much more. The touch of nature helps unveil <br class="d-none d-lg-block"> our true strength & sensuality.
                </p>
            </div>
        </div>
        <!--  -->
        <!-- Lookbook -->
        <section class="section-cosmetic-lookbook swiper-action-wrap">
            <div class="container-5">
                <div class="row flex-wrap-reverse">
                    <div class="col-md-6">
                        <div class="col-left">
                            <div class="s-header-3 wow fadeZoom">
                                <h3 class="title letter-space--4 text-black text-center">
                                    <span>Dermal</span> <br> Repair Cream
                                </h3>
                            </div>
                                            ...
                                            <div class="card-product card-product-v02 bg-white">
                                                <div class="card-product_wrapper">
                                                    ...
                                                    <ul class="product-badge-list">
                                                        <li class="product-badge text-body-4 small">
                                                            New
                                                        </li>
                                                    </ul>
                                                </div>
        ...
        <div class="flat-spacing-4">
            <div class="container-5">
                <div dir="ltr" class="swiper tf-swiper" data-preview="6" data-tablet="4" data-mobile-sm="3" data-mobile="2" data-space-lg="20" data-space-md="12" data-space="12" data-pagination="2" data-pagination-sm="3" data-pagination-md="4" data-pagination-lg="6">
                    <div class="swiper-wrapper">
                        <!-- item 1 -->
                        <div class="swiper-slide">
                            <div class="wg-icon">
                                <div class="ic-wrap">
                                    <i class="icon icon-ametic"></i>
                                </div>
                                <p class="text text-body-1 text-black text-center">
                                    Vegan & Cruelty <br> Free
                                </p>
                            </div>
                        </div>
                        <!-- item 2 -->
                        <div class="swiper-slide">
                            <div class="wg-icon">
                                <div class="ic-wrap">
                                    <i class="icon icon-proven"></i>
                                </div>
                                <p class="text text-body-1 text-black text-center">
                                    100% Transparent <br> & Proven Formula
                                </p>
                            </div>
                        </div>
                        <!-- item 3 -->
                        ...
                        <div class="swiper-slide">
                            <div class="wg-icon">
                                <div class="ic-wrap">
                                    <i class="icon icon-pure"></i>
                                </div>
                                <p class="text text-body-1 text-black text-center">
                                    Clean & Pure <br> Beauty
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="sw-dot-pagination tf-sw-pagination"></div>
                </div>
            </div>
        </div>
        <!-- /Box Icon -->
            ...
            <div class="container-5">
                <div class="s-header-3">
                    <div class="ic-head wow fadeIn">
                        <i class="icon icon-triple-leave"></i>
                    </div>
        ...
        <!-- /Testimonial -->
        <!-- FAQ -->
        <section class="section-cosmetic-faq flat-spacing-4 pt-0">
            <div class="container-5">
                <div class="s-header-3 wow fadeZoom">
                    <h3 class="title fw-normal letter-space--3 text-black text-center">
