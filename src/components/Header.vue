<template>
    ...
    <div class="main_nav_container">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <router-link to="/">
              <a class="brand-logo" href="https://inway.com.in:443."
                ><img
                  class="brand-image"
                  src="@/assets/images/uploads_setting_uploads-setting-vimas-logo-png-1.png"
                  alt="Quick Ecommerce"
              /></a>
            </router-link>
            <nav class="navbar">
              <ul class="navbar_menu">
                <router-link to="/">
                  <li class="menu-item">
                    <a class="menu-link" id="13"> HOME</a>
                  </li>
                </router-link>

                <router-link to="/about-us">
                  <li class="menu-item">
                    <a class="menu-link" id="14"> ABOUT US</a>
                  </li>
                </router-link>
                <router-link to="/shop">
                  <li class="menu-item">
                    <a class="menu-link" id="39"> SHOP</a>
                  </li>
                </router-link>
                <router-link to="/contact-us">
                  <li class="menu-item">
                    <a class="menu-link" id="44"> CONTACT</a>
                  </li>
                </router-link>
              </ul>
                  ...
                  <div class="header-middle-wrap">
                    <div class="header-right">
                      <div class="cart single-btn">
                        ...
                        >
                          <div
                            class="btn-left selector menu cart-wrapper icon-wrapper"
                            id="selector-menu"
                          >
                            <i class="btn-icon bi bi-cart3"></i>
                            <span
                              class="cart-count"
              ...
              <div class="icon-wrapper" style="cursor: pointer">
                <i class="fas fa-user" @click="goToProfile"></i>
              </div>
            </nav>
          </div>
        </div>
  ...
  <!-- mobile-header-area area start here  side cart -->
  ...
  <div
    ...
    tabindex="-1"
    id="cartOffcanvasSidebar"
    aria-labelledby="cartOffcanvasSidebarLabel"
  >
    <div class="offcanvas-header">
      <h5
        class="offcanvas-title"
        id="cartOffcanvasSidebarLabel"
        style="display: flex; align-items: center; gap: 140px"
      >
        Shopping Cart
    ...
    <div class="offcanvas-body">
      ...
      >
        <div class="container">
          <div class="empty-box-wrap text-center">
            <img
              class="empty-box-img"
              src="@/assets/ui/images/empty-box.webp"
              alt="empty-box"
            />
            <p class="empty-box-content">Enjoy Shopping</p>
            <router-link to="/shop"
              ><a class="primary-btn">Shop Now</a></router-link
            >
          </div>
        </div>
      </div>
      ...
      <div class="total-bottom-part" v-else>
        <div class="cart-cards">
          ...
          >
            ...
            <div class="cart-card-info">
              ...
              <p class="cart-subtext">Smooth | Nourish</p>
            ...
            <div class="cart-card-total">
              ...
              <a class="remove-link" @click="cartStore.removeItem(item)">
                Remove
              </a>
            </div>
          </div>
        ...
        <div class="total-count d-flex">
          <h3>Total</h3>
          <h4>
            <span class="side-cart-prod-over-totals"
        ...
        <a
          ...
          class="proceed-to-btn d-block text-center"
